<?php
	...
	$tables="Alumnos";
	$sWhere=" alu_idAsesorInterno IS NULL OR alu_idAsesorInterno = 0";
				...
				<?php
					...
					?>
						<tr>
							...
							<td><button class="btn btn-primary" onclick="asignarAlumnoAI(<?php echo $row['alu_id']; ?>,this)"><i class="fa fa-plus-square"></i></button></td>
						</tr>
					<?php
						$finales++;
					}		
