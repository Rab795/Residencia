<?php
	...
	$tables="Alumnos";
	$sWhere=" alu_idProyecto = ".$idproyecto;
				...
				<?php
					...
					?>
						<tr>
							...
							<td><button class="btn btn-danger" onclick="confirmDialog('Desea denegar al alumno','denegarAlumnoProyecto','<?php echo $row['alu_id']; ?>')"><i class="fa fa-user-slash"></i></button></td>
						</tr>
					<?php
						$finales++;
					}		
