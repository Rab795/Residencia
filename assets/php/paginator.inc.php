...
**
**	Versión 1.7.0	(20/10/2014):	-Se cambiaron las consultas de mysql (depreciado) a mysqli.
** 
**	Descripción :
 ...
 */
 ...
 if($_pagi_conteo_alternativo == false){
 	$_pagi_sqlConta = $_pagi_sql;
 	$_pagi_result2 = mysqli_query($conectado, $_pagi_sqlConta);
	// Si ocurrió error y mostrar errores está activado
 	if($_pagi_result2 == false && $_pagi_mostrar_errores == true){
		die (" Error en la consulta de conteo de registros: $_pagi_sqlConta. Mysql dijo: <b>".mysqli_error($conectado)."</b>");
 	}
 	$_pagi_totalReg = mysqli_num_rows($_pagi_result2);//total de registros
 }else{
	$_pagi_result3 = mysqli_query($conectado, $_pagi_sql);
	// Si ocurrió error y mostrar errores está activado
 	if($_pagi_result3 == false && $_pagi_mostrar_errores == true){
		die (" Error en la consulta de conteo alternativo de registros: $_pagi_sql. Mysql dijo: <b>".mysqli_error($conectado)."</b>");
 	}
 ...
 */
 ...
 $_pagi_result = mysqli_query($conectado, $_pagi_sqlLim);
 // Si ocurrió error y mostrar errores está activado
 if($_pagi_result == false && $_pagi_mostrar_errores == true){
 	die ("Error en la consulta limitada: $_pagi_sqlLim. Mysql dijo: <b>".mysqli_error($conectado)."</b>");
 }
