				...
				<?php
					...
					?>
						<tr>
							...
							<td><button class="btn btn-danger" onclick="confirmDialog('Desea denegar al alumno','denegarAlumnoAsesorI','<?php echo $row['alu_id']; ?>')"><i class="fa fa-user-slash"></i></button></td>
						</tr>
					<?php
						$finales++;
					}		
