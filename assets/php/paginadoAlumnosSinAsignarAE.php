<?php
	...
	$tables="Alumnos";
	$sWhere=" alu_idAsesorExterno IS NULL OR alu_idAsesorExterno = 0";
				...
				<?php
					...
					?>
						<tr>
							...
							<td><button class="btn btn-primary" onclick="asignarAlumnoAE(<?php echo $row['alu_id']; ?>,this)"><i class="fa fa-plus-square"></i></button></td>
						</tr>
					<?php
						$finales++;
					}		
